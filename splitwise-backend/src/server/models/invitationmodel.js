...
class InvitationModel {
  ...
  getInvitation = (user) => {
    return new Promise((resolve, reject) => {
      con.query("USE main;");
      var sql = `select * from participants inner join grps on participants.grp_id=grps.grp_id where participants.user_name='${user.user}' AND participants.status='PENDING'`;
